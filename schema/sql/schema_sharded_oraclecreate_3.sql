...
GRANT SELECT,INSERT,DELETE,UPDATE ON "HLT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "DEADTIME_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "PXL_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "HFOC_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "ONLINE_RESULT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "PLT_RESULT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "BCMF_RESULT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "HFET_RESULT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "HFOC_RESULT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "TRG_3" TO CMS_LUMI_W;
CREATE TABLE BEAM_3(DATATAGID NUMBER(20) ,EGEV BINARY_FLOAT ,INTENSITY1 BINARY_FLOAT ,INTENSITY2 BINARY_FLOAT ,BXIDXBLOB BLOB ,BXINTENSITY1BLOB BLOB ,BXINTENSITY2BLOB BLOB ,NCOLLIDINGBX NUMBER(5) ,BXPATTERN BLOB ,BXCONFIG1BLOB BLOB ,BXCONFIG2BLOB BLOB ,NCOLLIDABLES NUMBER(5) ,COLLIDABLES BLOB ,CONSTRAINT BEAM_3_PK PRIMARY KEY(DATATAGID));
GRANT SELECT ON "BEAM_3" TO PUBLIC;
GRANT SELECT,INSERT,DELETE,UPDATE ON "BEAM_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "OFFLINE_RESULT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "PLT_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "BCMF_3" TO CMS_LUMI_W;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON "HFET_3" TO CMS_LUMI_W;