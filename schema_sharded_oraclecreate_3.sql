...
CREATE TABLE ONLINE_RESULT_3(RUNNUM NUMBER(10) ,LSNUM NUMBER(10) ,FILLNUM NUMBER(10) ,CMSON NUMBER(1) ,BEAMSTATUS VARCHAR2(4000) ,DELIVERED BINARY_FLOAT ,RECORDED BINARY_FLOAT ,BXDELIVEREDBLOB BLOB ,AVGPU BINARY_FLOAT ,DATASOURCE VARCHAR2(4000) ,NORMTAGID NUMBER(20) ,CONSTRAINT ONLINE_RESULT_3_PK PRIMARY KEY(RUNNUM,LSNUM));
GRANT SELECT ON "ONLINE_RESULT_3" TO PUBLIC;

CREATE TABLE PLT_RESULT_3(DATATAGID NUMBER(20) ,NORMTAGID NUMBER(20) ,AVGLUMI BINARY_FLOAT ,BXLUMIBLOB BLOB ,CONSTRAINT PLT_RESULT_3_PK PRIMARY KEY(DATATAGID,NORMTAGID));
GRANT SELECT ON "PLT_RESULT_3" TO PUBLIC;

CREATE TABLE BCMF_RESULT_3(DATATAGID NUMBER(20) ,NORMTAGID NUMBER(20) ,AVGLUMI BINARY_FLOAT ,BXLUMIBLOB BLOB ,CONSTRAINT BCMF_RESULT_3_PK PRIMARY KEY(DATATAGID,NORMTAGID));
GRANT SELECT ON "BCMF_RESULT_3" TO PUBLIC;

CREATE TABLE HFET_RESULT_3(DATATAGID NUMBER(20) ,NORMTAGID NUMBER(20) ,AVGLUMI BINARY_FLOAT ,BXLUMIBLOB BLOB ,CONSTRAINT HFET_RESULT_3_PK PRIMARY KEY(DATATAGID,NORMTAGID));
GRANT SELECT ON "HFET_RESULT_3" TO PUBLIC;

CREATE TABLE HFOC_RESULT_3(DATATAGID NUMBER(20) ,NORMTAGID NUMBER(20) ,AVGLUMI BINARY_FLOAT ,BXLUMIBLOB BLOB ,CONSTRAINT HFOC_RESULT_3_PK PRIMARY KEY(DATATAGID,NORMTAGID));
GRANT SELECT ON "HFOC_RESULT_3" TO PUBLIC;

CREATE TABLE TRG_3(DATATAGID NUMBER(20) ,BITID NUMBER(5) ,BITNAMEID NUMBER(5) ,PRESCIDX NUMBER(5) ,PRESCVAL NUMBER(10) ,COUNTS NUMBER(10) ,CONSTRAINT TRG_3_PK PRIMARY KEY(DATATAGID,BITNAMEID));
